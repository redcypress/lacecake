...
class javo_archive_categories extends WP_Widget {
	public function __construct(){
		...
		parent::__construct(
			...
			__('[JAVO] Archive Categories', JAVO_FR), // Name
			array( 'description' => __( 'Javo Archive Categories Navigation', JAVO_FR ), ) // Args
		);

	}
	static function javo_archive_categories_callback(){
	...
	public function form( $instance ) {
		...
		<fieldset style="margin-bottom:10px;">
			...
			<label style="position:relative; bottom:7px;"><?php _e('Background Color', 'javo_fr');?></label>
		</fieldset>
		<fieldset style="margin-bottom:10px;">
			...
			<label style="position:relative; bottom:7px;"><?php _e('Text Color', 'javo_fr');?></label>
		</fieldset>
