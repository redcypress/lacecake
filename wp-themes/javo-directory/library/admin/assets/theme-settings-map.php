<div class="javo_ts_tab javo-opts-group-tab hidden" tar="map">
	...
	<tr><th>
		...
		<h4><?php _e('Read More Item', 'javo_fr');?></h4>
		<fieldset class="inner">
			<div>
				<label>
					<input type="radio" name="javo_ts[map][map_wide_read_more]" value='' <?php checked($javo_ts_map->get('map_wide_read_more') == '');?>>
					<?php _e('Pagination', 'javo_fr');?>
				</label>
			</div>
			<div>
				<label>
					<input type="radio" name="javo_ts[map][map_wide_read_more]" value="read_more" <?php checked($javo_ts_map->get('map_wide_read_more') == 'read_more');?>>
					<?php _e('Read More Button', 'javo_fr');?>
				</label>
			</div>
		</fieldset>
	</td></tr><tr><th>
		...
		<h4><?php _e('Item List Settings on Wide Map ', 'javo_fr');?></h4>
		<fieldset class="inner">
			<div>
				<label>
					<input type="radio" name="javo_ts[map][map_wide_content_overflow]" value='' <?php checked($javo_ts_map->get('map_wide_content_overflow') == '');?>>
					<?php _e('Able a scroll bar.', 'javo_fr');?>
				</label>
			</div>
			<div>
				<label>
					<input type="radio" name="javo_ts[map][map_wide_content_overflow]" value="overflow" <?php checked($javo_ts_map->get('map_wide_content_overflow') == 'overflow');?>>
					<?php _e('Disable a scroll bar.', 'javo_fr');?>
				</label>
			</div>
		</fieldset>
	...
	<tr><th>
		...
		<h4><?php _e('Amount Of Items Per Map Page', 'javo_fr');?></h4>
		<fieldset class="inner">
			<input type="text" name="javo_ts[map][box_item_count]" value="<?php echo (int)$javo_ts_map->get("box_item_count", 0);?>">
