...
<!-- Themes setting > General -->
	...
	<td>
		<h4><?php _e("Main Logo","javo_fr"); ?></h4>
		<fieldset class="inner">
			<input type="text" name="javo_ts[logo_url]" value="<?php echo $javo_theme_option['logo_url']?>" tar="g01">
			<input type="button" class="button button-primary fileupload" value="<?php _e('Select Image', 'javo_fr');?>" tar="g01">
			<input class="fileuploadcancel button" tar="g01" value="<?php _e('Delete', 'javo_fr');?>" type="button">
			<p>
