...
<table class="form-table">
	...
	<tr><th>
		...
		<!-- Detail Page -->
		<h4><?php _e('Item Description Page - Map Maker', 'javo_fr');?></h4>
		<fieldset>
		...
		<fieldset style="padding:0 0 0 30px;">
			<div>
				<label>
		...
		<fieldset style="padding:0 0 0 30px;">
			<div>
				<label><input type="checkbox" name="javo_ts[top_featured_and_map]" value="disabled" <?php checked($javo_tso->get('top_featured_and_map')== "disabled");?>><?php _e('Disbled', 'javo_fr');?></label>
			</div>
		</fieldset>
	...
	<tr><th>
		<?php _e("Single Item Page Menu Settings","javo_fr"); ?>
	</th><td>
		<h4><?php _e("Use Other Background","javo_fr"); ?></h4>
		<fieldset class="inner">
			<label><input type="checkbox" name="javo_ts[single_page_menu_other_bg_color]" value="use" <?php checked($javo_tso->get('single_page_menu_other_bg_color')== "use");?>><?php _e('Use', 'javo_fr');?></label>
		</fieldset>
