						...
						<div class="panel panel-default panel-wrap">
							...
							<!-- Starting Content -->
								...
								<form method="post" id="javo-add-review-form">
									...
									<div class="form-group">
										<label><?php echo $javo_custom_item_label->get('reviews', 'Reviews'); _e('  Content', 'javo_fr');?></label>
									...
									<div class="form-group">
										<div class="col-md-12" align="center">
											<a class='btn btn-primary item_submit'>
												<?php
												echo  isset($edit) ?
													sprintf( __("Edit This %s", 'javo_fr' ), $javo_custom_item_label->get('reviews', 'Reviews')):
													sprintf( __("Save This %s", 'javo_fr' ), $javo_custom_item_label->get('reviews', 'Reviews'));
												?>
											</a>
										</div>
									</div>
								...
								<?php
								$alerts = Array(
									"title_null"			=> sprintf(__("Please type %s title", 'javo_fr'), $javo_custom_item_label->get('reviews', 'review') )
									, "content_null"		=> sprintf(__("Please type %s content", 'javo_fr'), $javo_custom_item_label->get('reviews', 'review') )
