									...
									<div class="form-group">
										<div class="col-md-12" align="center">
											<a class='btn	btn-primary	item_submit'>
												<?php isset($edit)? printf(__("Edit This %s","javo_fr"), $javo_custom_item_label->get('events', 'Events')) : printf(__("Save My %s","javo_fr"), $javo_custom_item_label->get('events', 'Events')); ?>
											</a>
										</div>
									</div>
								</form>
