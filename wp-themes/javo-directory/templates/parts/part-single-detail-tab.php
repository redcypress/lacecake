			...
			<div class="item-single-details-box">
				...
				<div class="inner-items">
					<ul>
						...
						<?php
						if( $javo_directory_query->get('address', NULL) != NULL ):
							printf('<li class="single-contact-address"><span>%s</span>%s</li>', __('Address', 'javo_fr'), $javo_directory_query->get('address'));
						endif;
						if( $javo_directory_query->get('phone', NULL) != NULL ):
							printf('<li class="single-contact-phone"><span>%s</span>%s</li>', __('Phone', 'javo_fr'), $javo_directory_query->get('phone'));
						endif;
						if( $javo_directory_query->get('email', NULL) != NULL):
							printf('<li class="single-contact-email"><span>%s</span><a href="mailto:%s" target="_self">%s</a></li>'
								, __('Email', 'javo_fr')
						...
						if( $javo_directory_query->get('website', NULL) != NULL):
							printf('<li class="single-contact-website"><span>%s</span><a href="%s" target="_blank">%s</a></li>'
								, __('Website', 'javo_fr')
		...
		if( $javo_video_query->get('single_position', 'slide') == 'contact' ){
			...
			if( !empty( $javo_custom_field ) ){
				foreach($javo_custom_field as $field){
					...
					if( empty( $javo_this_value ) || $javo_this_value == '' )
					{
						continue;
					}
