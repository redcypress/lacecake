...
<div class="row">
	<div class="col-md-12">
		<form role="form" class="form-horizontal" method="post" id="frm_item">
			<div class="row">
				<div class="col-md-8 col-sm-12 form-left">
					...
					<div class="line-title-bigdots">
						<h2><span><?php echo $javo_tso->get('field_caption', __('Additional Information', 'javo_fr'));?></span></h2>
		...
		$alerts = Array(
			...
			, "item_new_success"	=> __('Thanks For Posting Your Item!', 'javo_fr')
		);
		?>
		...
		jQuery(function($){
			...
			window.javo_add_item_func = {
				...
				, submit:function(e)
				{
					...
					if( $object.empty_field( '[name="txt_title"]', "<?php echo $alerts['title_null'];?>") == false ) return false;
					$(this).button('loading');
					$.ajax(options);
				}
