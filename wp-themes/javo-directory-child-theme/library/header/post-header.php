...
if($post_id != "" && $post_id > 0){
    ...
    break; case "default": default:
        if( !is_singular("item") ){
            ?>
                <div class="feature-bg search" style="background:url('/wp-content/themes/javo-directory-child-theme/assets/images/blog-bg.jpg') no-repeat center center fixed;  -webkit-background-size: cover;  -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-attachment: fixed;">
                    <div class="container">
                        <div class="row margin-md">
                            <div class="col-xs-7">
                                <h2>
                                    <a href="/blog" class="text-pink margin-sm">
                                        L&amp;C Blog
                                    </a>
                                </h2>
                            </div>
                            <div class="visible-xs col-xs-5">
                                <a href="#" class="btn btn-lg btn-contact book margin-sm" data-toggle="modal" data-target="#followBlog">
                                    Follow
                                </a>
                            </div>
                        </div>
