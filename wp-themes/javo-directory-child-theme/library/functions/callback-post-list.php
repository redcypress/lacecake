        ...
        <div class="row javo-item-grid-listing">
            ...
            if( $posts->have_posts() ){
                while($posts->have_posts() ){
                    ...
                    ?>
                    <div class="col-md-4 col-sm-6 col-xs-6 pull-left search-results">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    ...
                                    <ul class="list list-unstyled">
                                        <li class="text-center text-excerpt javo-grid-listing-excerpt">
											<p>
												<?php echo javo_str_cut(get_the_excerpt(), 150);?>
											</p>
										</li>
                                    </ul><!-- List group -->
                                </div>
                                    ...
                                    <?php if( $javo_custom_item_tab->get('events', '') == ''):?>
                                        <div class="pull-left">
                                            <ul class="pagination pagination-sm no-margin pagination-dark">
                                                ...
                                                <li class="active"><a href="#"><?php _e($javo_custom_item_label->get('events', 'Events').'(s)', 'javo_fr');?></a></li>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if( $javo_custom_item_tab->get('reviews', '') == ''):?>
                                        <div class="pull-left">
                                            <ul class="pagination pagination-sm no-margin pagination-dark">
                                                ...
                                                <li class="active"><a href="#"><?php _e($javo_custom_item_label->get('reviews', 'Reviews').'(s)', 'javo_fr');?></a></li>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="row blog-wrap-inner">
                                    <div class="col-md-5 col-sm-5 col-xs-5 img-wrap">
                                        <div class="javo_img_hover">
                                            <?php the_post_thumbnail('javo-box', Array('class'=> 'img-responsive', 'style'=>'width:100%;'));?>
                                        </div> <!-- javo_img_hover -->
                                    </div> <!-- col-md-5 -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-4 text-right">
                                                <span class="javo-sns-wrap social-wrap">
                                                    <i class="sns-facebook" data-title="<?php the_title();?>" data-url="<?php the_permalink();?>">
                                                        <a class="social-media-icon-sm javo-tooltip" title="<?php _e('Share Facebook', 'javo_fr');?>">
                                                            <i class="fa fa-facebook text-white"></i>
                                                        </a>
                                                    </i>
                                                    <i class="sns-twitter" data-title="<?php the_title();?>" data-url="<?php the_permalink();?>">
                                                        <a class="social-media-icon-sm javo-tooltip" title="<?php _e('Share Twitter', 'javo_fr');?>">
